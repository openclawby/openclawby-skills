...
`local/index/` holds a machine-readable index of all 386 relay interfaces + the RPC chain map (derived from `api/clawby.yaml`; regenerate with `python3 local/index/build_index.py` after a skill update):
